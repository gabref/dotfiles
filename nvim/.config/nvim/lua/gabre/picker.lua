...
local my_picker_group = vim.api.nvim_create_augroup("GabuPickerGroup", { clear = true })

function ColorMyPencils(color, set_background)
	color = color or 'rose-pine' -- 'rose-pine'
...
function MyColorPicker()
	...
	vim.api.nvim_clear_autocmds({ group = my_picker_group })

	for _, color in ipairs(All_colorschemes) do
